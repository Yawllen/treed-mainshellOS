...
```bash
cd /home/pi
sudo systemctl stop KlipperScreen || true
sudo rm -rf treed
mkdir -p treed/.staging
git clone --depth 1 --filter=blob:none https://github.com/Yawllen/treed-mainshellOS.git treed/.staging/treed-mainshellOS
